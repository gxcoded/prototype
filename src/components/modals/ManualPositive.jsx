...
const ManualPositive = ({ manualInfo, reloader }) => {
  ...
  const sendNow = async () => {
    if (selectedType) {
      if (file) {
        ...
        try {
          const res = await axios.post(`${url}/manualPositive`, formData, {
            headers: {
        ...
        <div className="modal-dialog" role="document">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title">Report As Positive</h5>
            </div>
